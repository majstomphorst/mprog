# application.py for mashup cs50 childeren program's helpers.py and scripts.js
# Programmeren 02 - pset 08 - exercise 01
# By Maxim Stomphorst
#
# This programma make's a website with a google map of the Netherlands
# and displaying local news. 
